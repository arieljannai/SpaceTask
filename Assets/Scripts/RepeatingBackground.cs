...
public class RepeatingBackground : MonoBehaviour 
{
	...
	private void Update()
	{
		...
		if (transform.position.x < (-groundHorizontalLength))
		{
            ...
            //BackgroundsManager.Instance.PutNextBackground(this.gameObject);
            //GameController.instance.UpdateDistanceScore();
        }
    }
	...
	private void RepositionBackground()
	{
		...
		Vector2 groundOffSet = new Vector2(groundHorizontalLength * 4, 0);
